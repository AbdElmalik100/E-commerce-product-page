<template>
    <header class="header mx-5 py-4 d-flex align-items-center justify-content-between position-relative">
        ...
        <div class="right-side d-flex align-items-center gap-5">
            <div :data-cart="cart" class="cart-cont" @click="popupOpen = !popupOpen">
